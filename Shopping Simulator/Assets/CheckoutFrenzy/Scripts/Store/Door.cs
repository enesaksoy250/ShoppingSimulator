...
namespace CryingSnow.CheckoutFrenzy
{
    ...
    public class Door : MonoBehaviour, IInteractable
    {
        ...
        public void OnFocused()
        {
            ...
            string closeText = LanguageManager.instance.GetLocalizedValue("CloseText");
            string openText = LanguageManager.instance.GetLocalizedValue("OpenText");
            string action = isOpen ? LanguageManager.instance.GetLocalizedValue("TapToCloseDoorText") 
                : LanguageManager.instance.GetLocalizedValue("TapToOpenDoorText");
           
            UIManager.Instance.InteractMessage.Display(action);
        }

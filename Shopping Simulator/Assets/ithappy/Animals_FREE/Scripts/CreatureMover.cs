...
namespace Controller
{
    ...
    public class CreatureMover : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ChooseNewDestination(); // Baþlangýç hedefi seç
        }
        ...
        private void Update()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SetInput(axis, currentDestination, false, false);
                }
            }
        ...
        private void ChooseNewDestination()
        {
            ...
            currentDestination = new Vector3(randomPoint.x + m_Transform.position.x, m_Transform.position.y, randomPoint.y + m_Transform.position.z);
            m_Target = currentDestination;
        }
